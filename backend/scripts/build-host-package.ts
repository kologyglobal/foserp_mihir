 ...
 *   npx tsx scripts/build-host-package.ts
 *   npx tsx scripts/build-host-package.ts --domain=https://erp.dhurandharcrm.com
 */
...
function main() {
  ...
  // 1) Production frontend build (same-origin API)
  run(
    'npm',
    ['run', 'build'],
    FRONTEND,
