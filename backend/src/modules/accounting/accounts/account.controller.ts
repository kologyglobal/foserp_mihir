...
export const listAccounts = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendPaginated(res, 'accounts listed', result.items, buildPaginationMeta(result.total, result.page, result.limit))
})

export const getAccountTree = asyncHandler(async (req: Request, res: Response) => {
  const tenantId = getTenantId(req)
  const tree = await service.getTree(req, tenantId, req.query as never)
  return sendSuccess(res, 'account tree fetched', tree)
})
...
export const getAccount = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendSuccess(res, 'account fetched', item)
})
...
export const applyTemplate = asyncHandler(async (req: Request, res: Response) => {
  const tenantId = getTenantId(req)
  const item = await service.applyTemplateRecord(req, tenantId, req.body)
...
export const updateAccount = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendSuccess(res, 'account updated', item)
})
...
export const activateAccount = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendSuccess(res, 'account activated', item)
})
...
export const deactivateAccount = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendSuccess(res, 'account deactivated', item)
})
