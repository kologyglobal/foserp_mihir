...
export const MAPPING_KEY_ACCOUNT_TYPES: Partial<Record<DefaultAccountMappingKey, AccountType[]>> = {
  ...
  GST_INPUT_CESS: ['GST_INPUT'],
  GST_RCM_CGST_PAYABLE: ['GST_OUTPUT', 'GST_INPUT'],
  GST_RCM_SGST_PAYABLE: ['GST_OUTPUT', 'GST_INPUT'],
  GST_RCM_IGST_PAYABLE: ['GST_OUTPUT', 'GST_INPUT'],
  ITC_INELIGIBLE_EXPENSE: ['EXPENSE'],
  GST_ROUND_OFF: ['EXPENSE', 'INCOME'],
  GST_INTEREST: ['EXPENSE'],
  GST_LATE_FEE: ['EXPENSE'],
...
export const MAPPING_KEY_CATEGORIES: Partial<Record<DefaultAccountMappingKey, AccountCategory[]>> = {
  ...
  ACCRUED_EXPENSE_LIABILITY: ['LIABILITY'],
  PREPAID_EXPENSE_ASSET: ['ASSET'],
  // HRMS Phase 9 — payroll (optional mappings)
  SALARY_BASIC_EXPENSE: ['EXPENSE'],
  SALARY_HRA_EXPENSE: ['EXPENSE'],
  SALARY_ALLOWANCE_EXPENSE: ['EXPENSE'],
  SALARY_OT_EXPENSE: ['EXPENSE'],
  SALARY_PAYABLE: ['LIABILITY'],
  PF_EMPLOYEE_PAYABLE: ['LIABILITY'],
  PF_EMPLOYER_PAYABLE: ['LIABILITY'],
  PF_EMPLOYER_EXPENSE: ['EXPENSE'],
  ESIC_EMPLOYEE_PAYABLE: ['LIABILITY'],
  ESIC_EMPLOYER_PAYABLE: ['LIABILITY'],
  ESIC_EMPLOYER_EXPENSE: ['EXPENSE'],
  PT_PAYABLE: ['LIABILITY'],
  TDS_SALARY_PAYABLE: ['LIABILITY'],
  LWF_PAYABLE: ['LIABILITY'],
  LWF_EMPLOYER_PAYABLE: ['LIABILITY'],
  LWF_EMPLOYER_EXPENSE: ['EXPENSE'],
  EMPLOYEE_LOAN_RECEIVABLE: ['ASSET'],
  SALARY_ADVANCE_RECEIVABLE: ['ASSET'],
  EMPLOYEE_FNF_PAYABLE: ['LIABILITY'],
  EMPLOYEE_FNF_RECEIVABLE: ['ASSET'],
  LEAVE_ENCASHMENT_EXPENSE: ['EXPENSE'],
  NOTICE_PAY_EXPENSE: ['EXPENSE'],
  NOTICE_RECOVERY_INCOME: ['INCOME'],
  ASSET_RECOVERY_INCOME: ['INCOME'],
}
