 ...
 */
export function normalizeSupplierReferenceNumber(raw: string): string {
 ...
 * tenantId|legalEntityId|vendorId|financialYearId|supplierReferenceNumberNormalized
 */
export function buildSupplierReferenceUniquenessKey(parts: {
  tenantId: string
  ...
  return [
    ...
    parts.supplierReferenceNumberNormalized,
  ].join('|')
}
