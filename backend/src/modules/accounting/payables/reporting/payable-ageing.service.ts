...
export function classifyDocumentAgeBucket(reportDate: string, postingDate: string | null | undefined): DocumentAgeBucket {
...
export function isDocumentAgeBucket(value: string): value is DocumentAgeBucket {
...
export function documentAgeFilterForBucket(bucket: DocumentAgeBucket, reportDate: string) {
  ...
  switch (bucket) {
    case 'AGE_0_30':
      return { postingDate: postingDateFilter(0, 30), documentDate: postingDateFilter(0, 30) }
    case 'AGE_31_60':
      return { postingDate: postingDateFilter(31, 60), documentDate: postingDateFilter(31, 60) }
    case 'AGE_61_90':
      return { postingDate: postingDateFilter(61, 90), documentDate: postingDateFilter(61, 90) }
    case 'AGE_91_120':
      return { postingDate: postingDateFilter(91, 120), documentDate: postingDateFilter(91, 120) }
    case 'AGE_ABOVE_120':
      return {
        postingDate: { lte: parseDateOnly(addDays(reportDate, -121)) },
        documentDate: { lte: parseDateOnly(addDays(reportDate, -121)) },
      }
    default:
      return {}
  }
...
export const ALL_DOCUMENT_AGE_BUCKETS: DocumentAgeBucket[] = [
  'AGE_0_30',
  'AGE_31_60',
  'AGE_61_90',
  'AGE_91_120',
