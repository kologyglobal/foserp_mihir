...
const mappingItemSchema = z.object({
  mappingKey: z.enum([
    ...
    'GST_INPUT_CGST', 'GST_INPUT_SGST', 'GST_INPUT_IGST', 'GST_INPUT_CESS',
    'GST_OUTPUT_CGST', 'GST_OUTPUT_SGST', 'GST_OUTPUT_IGST', 'GST_OUTPUT_CESS',
    'GST_RCM_CGST_PAYABLE', 'GST_RCM_SGST_PAYABLE', 'GST_RCM_IGST_PAYABLE',
