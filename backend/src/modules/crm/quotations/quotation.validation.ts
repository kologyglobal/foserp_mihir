...
const priceLineSchema = z
  ...
  sacCode: z.string().trim().max(32).optional().nullable(),
  uomCode: z.string().trim().max(16).optional().nullable(),
  taxGroupId: z.string().uuid().optional().nullable(),
  taxGroupCode: z.string().trim().max(64).optional().nullable(),
  gstPct: z.coerce.number().min(0).max(100).optional().nullable(),
  cgstPct: z.coerce.number().min(0).max(100).optional().nullable(),
  sgstPct: z.coerce.number().min(0).max(100).optional().nullable(),
  utgstPct: z.coerce.number().min(0).max(100).optional().nullable(),
  igstPct: z.coerce.number().min(0).max(100).optional().nullable(),
  cessPct: z.coerce.number().min(0).max(100).optional().nullable(),
  taxScheme: z.string().trim().max(32).optional().nullable(),
  taxableAmount: z.coerce.number().min(0).optional().nullable(),
  taxAmount: z.coerce.number().min(0).optional().nullable(),
  cgstRate: z.coerce.number().min(0).max(100).optional().nullable(),
  sgstRate: z.coerce.number().min(0).max(100).optional().nullable(),
  utgstRate: z.coerce.number().min(0).max(100).optional().nullable(),
  igstRate: z.coerce.number().min(0).max(100).optional().nullable(),
  cgstAmount: z.coerce.number().min(0).optional().nullable(),
  sgstAmount: z.coerce.number().min(0).optional().nullable(),
  utgstAmount: z.coerce.number().min(0).optional().nullable(),
...
export const createQuotationSchema = z.object({
  ...
  orderDiscountCalcType: z.enum(['FLAT', 'PERCENTAGE']).optional(),
  orderDiscountValue: z.coerce.number().min(0).optional(),
  freightCalcType: z.enum(['FLAT', 'PERCENTAGE']).optional(),
  freightValue: z.coerce.number().min(0).optional(),
  freightIsTaxable: z.boolean().optional(),
  freightTaxRate: z.coerce.number().min(0).max(100).optional(),
  installationCalcType: z.enum(['FLAT', 'PERCENTAGE']).optional(),
  installationValue: z.coerce.number().min(0).optional(),
  installationIsTaxable: z.boolean().optional(),
  installationTaxRate: z.coerce.number().min(0).max(100).optional(),
  customChargesCalcType: z.enum(['FLAT', 'PERCENTAGE']).optional(),
  customChargesValue: z.coerce.number().min(0).optional(),
  customChargesIsTaxable: z.boolean().optional(),
  customChargesTaxRate: z.coerce.number().min(0).max(100).optional(),
