/**
 * 156 — 34′ × 5′ Side Wall Semi Trailer quotation sections.
 * Source: `156.34FT x5ft Side Wall Trailer.docx` (VF/QUO/26-27/156).
 */
...
export const SIDEWALL_34FT_5FT_SEED_VERSION = 1

export const SIDEWALL_34FT_5FT_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
