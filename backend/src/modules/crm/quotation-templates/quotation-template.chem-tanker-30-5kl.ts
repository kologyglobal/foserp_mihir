/**
 * 164 — 30.5 KL Chemical Tanker Trailer quotation sections.
 * Source: `164.30.5 KL Chemical Tanker Trailer.docx` (VF/QUO/26-27/164).
 */
...
export const CHEM_TANKER_30_5KL_SEED_VERSION = 1

export const CHEM_TANKER_30_5KL_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
