/**
 * 152 — 42 m³ Hopper Type Flour Bulker quotation sections.
 * Source: `152. 42m3 Hopper Type Flour Bulker.docx` (VF/QUO/26-27/152).
 */
...
export const FLOUR_BULKER_42M3_SEED_VERSION = 1

export const FLOUR_BULKER_42M3_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
  ...
  },
  {
    ...
    specRows: [
      ...
      specRow('1.3', 'Construction', 'Self-supported pressure vessel made of High Tensile Steel'),
  ...
  },
  {
    ...
    specRows: [
      ...
      specRow('4.5', 'Catwalk', 'M.S. catwalk on both sides — 300 mm wide with handrail and ladder'),
  ...
  },
  {
    ...
    specRows: [
      ...
      specRow('T.3', 'Payment Terms', '30% advance and balance against proforma invoice'),
