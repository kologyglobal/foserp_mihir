/**
 * 165 — 40 ft Walking Floor Container quotation sections.
 * Source: `165.40ft  Walking Floor.docx` (VF/QUO/26-27/165).
 */
...
export const WALKING_FLOOR_40FT_SEED_VERSION = 1

export const WALKING_FLOOR_40FT_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
