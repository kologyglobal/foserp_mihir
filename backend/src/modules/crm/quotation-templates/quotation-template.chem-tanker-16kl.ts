/**
 * 178 — 16 KL Chemical Tanker quotation sections.
 * Source: `178.16KL Chemical Tanker.docx` (VF/QUO/26-27/178).
 */
...
export const CHEM_TANKER_16KL_SEED_VERSION = 1

export const CHEM_TANKER_16KL_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
