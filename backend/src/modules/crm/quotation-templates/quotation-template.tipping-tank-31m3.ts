/**
 * 183 — 31 m³ Tipping Tank quotation sections.
 * Source: `183.31m3 Tipping Tank.docx` (VF/QUO/26-27/183).
 */
...
export const TIPPING_TANK_31M3_SEED_VERSION = 1

export const TIPPING_TANK_31M3_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
