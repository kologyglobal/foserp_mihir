/**
 * 109 — 25 m³ / 20' ISO Dry Bulk Tanker quotation sections.
 * Source: `109.25m3 ISO Tank Container.docx` (VF/QUO/26-27/109).
 * Placeholders merge at print/preview via {{snake_case}} tokens.
 */
...
export const ISO_DRY_BULK_25CBM_SEED_VERSION = 7

export const ISO_DRY_BULK_25CBM_SEED_SECTIONS: Array<Record<string, unknown>> = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
