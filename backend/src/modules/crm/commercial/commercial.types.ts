...
export function mapReceiptDto(row: CrmPaymentReceipt) {
  return {
    ...
    accountingReceiptId: row.accountingReceiptId,
    accountingMigrationStatus: row.accountingMigrationStatus,
    accountingMigrationError: row.accountingMigrationError,
    accountingMigratedAt: row.accountingMigratedAt?.toISOString() ?? null,
    commercialOnly: row.commercialOnly,
...
export function mapInvoiceDto(row: CrmTaxInvoice & { lines?: CrmTaxInvoiceLine[] }) {
  ...
  return {
    ...
    lastPaymentDate: row.lastPaymentDate ? d(row.lastPaymentDate) : null,
