...
export const PURCHASE_ERROR_CODE = {
  ...
  PO_QUALITY_TEST_GROUP_INVALID: 'PO_QUALITY_TEST_GROUP_INVALID',
...
export const PURCHASE_ERROR_MESSAGES: Record<string, string> = {
  ...
  [PURCHASE_ERROR_CODE.PO_QUALITY_TEST_GROUP_INVALID]:
    'Quality test group must be an active incoming inspection plan.',
