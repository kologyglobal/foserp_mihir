...
const generalSchema = z.object({
  ...
  requireApprovalOnPo: z.boolean().optional(),
  requirePoReleaseWorkflow: z.boolean().optional(),
  allowBackdatedPo: z.boolean().optional(),
  backdatedPoDaysLimit: z.coerce.number().int().min(0).max(400).optional(),
  requireApprovalForBackdatedPo: z.boolean().optional(),
