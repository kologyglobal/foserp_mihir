...
export function mapPurchaseOrderToDto(
  ...
  return {
    ...
    paymentTermId: (order as { paymentTermId?: string | null }).paymentTermId ?? null,
    deliveryTermId: (order as { deliveryTermId?: string | null }).deliveryTermId ?? null,
    ...
    termsAndConditions: (order as { termsAndConditions?: string | null }).termsAndConditions ?? null,
    ...
    lines: order.lines.map((line) => {
      ...
      return {
        ...
        itemId: line.itemId,
        lineType: (line as { lineType?: string }).lineType === 'SERVICE' ? 'SERVICE' : 'GOODS',
