import type { Prisma, QualityInspection, QualityInspectionLine, QualityInspectionStatus } from '@prisma/client'
...
export async function updateQualityInspection(
  tenantId: string,
  id: string,
  data: Prisma.QualityInspectionUncheckedUpdateInput,
  tx: Prisma.TransactionClient = prisma,
) {
  const result = await tx.qualityInspection.updateMany({
...
export type QualityInspectionWithLines = QualityInspection & { lines: QualityInspectionLine[] }
