...
export function mapPurchaseRequisitionLineToDto(
  ...
  return {
    ...
    gstRatePct: decimalToNumber(line.gstRatePctSnapshot),
    cgstRatePct: decimalToNumber(line.cgstRateSnapshot),
    sgstRatePct: decimalToNumber(line.sgstRateSnapshot),
    igstRatePct: decimalToNumber(line.igstRateSnapshot),
