...
| Convert guard | — | Requires `stage` or `lifecycleStatus` = **qualified** (422 otherwise) |
...
| Approve side effect | — | Sets `customerApproval=approved` in same transaction (no Accept API) |
...
Seed (dev): **31 countries**, **36 Indian states**, **108 cities**, **3 products**, **1 quotation template** (`STANDARD-TRAILER`).
