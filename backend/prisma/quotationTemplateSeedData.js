 ...
 */
function isoShellSections(title, subject) {
    return [
        {
            sectionType: 'cover',
            title: 'Quotation',
...
export const QUOTATION_TEMPLATE_SEED_ROWS = [
    {
        code: 'ISO-TANK-26KL',
        ...
        sections: isoShellSections('26 KL ISO Tank Container', 'Quotation for supply of 26 KL ISO Tank Container'),
    },
    {
        ...
        sections: isoShellSections('25 m³ ISO Tank Container', "Quotation for supply of 25 m³ ISO Tank Container (20' dry bulk / Model 25 CBM)"),
    },
];
...
//# sourceMappingURL=quotationTemplateSeedData.js.map