...
const LINK_ICONS: Record<string, ComponentType<{ className?: string }>> = {
  ...
  '/masters/bom': Layers,
  '/engineering/bom': Layers,
  '/serials': PackageCheck,
  '/masters/users': Users,
  '/masters/approval-workflows': ShieldCheck,
  '/masters/approval-matrix': ShieldCheck,
  ...
  '/masters/serial-numbers': PackageCheck,
  '/documents': FolderOpen,
  '/barcode': QrCode,
  '/barcode/master': ScanLine,
}
