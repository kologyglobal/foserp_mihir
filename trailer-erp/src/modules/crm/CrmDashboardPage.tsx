...
export function CrmDashboardPage() {
  ...
  const { data: apiMetrics, loading: apiMetricsLoading } = useCrmDashboardApiMetrics('month')
  ...
  const approvalPending = quotationDocuments.filter((d) => d.status === 'pending_approval').length
      ...
      >
        <div className="crm-dashboard-zones">
          ...
          <section className="crm-zone" aria-label="Action zone">
            ...
            <DynamicsDashboardGrid>
              <CrmQuotationApprovalPanel
                documents={metrics.pendingApprovalQuotations}
                customers={customers}
                opportunities={opportunities}
              />
            </DynamicsDashboardGrid>
