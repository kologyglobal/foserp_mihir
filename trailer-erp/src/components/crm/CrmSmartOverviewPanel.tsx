      ...
      >
        {lean ? (
          <div className="crm-smart-overview__qual-row">
            <h3 id="crm-smart-overview-progress" className="sr-only">
              {progressLabel}
            </h3>
            <strong aria-label={`Health ${clamped}%`}>{clamped}%</strong>
          </div>
        ) : (
          <div className="crm-smart-overview__qual-row">
            <h3 id="crm-smart-overview-progress" className="crm-smart-overview__section-title crm-smart-overview__section-title--inline">
              {progressLabel}
            </h3>
            <strong className={cn('crm-smart-overview__pct', `crm-smart-overview__pct--${tone}`)}>
              {clamped}%
            </strong>
          </div>
        )}
