          ...
          <tbody>
            {synced.map((line, idx) => {
              ...
              <tr key={line.id}>
                ...
                <td className="text-right">
                  {editable ? (
                    <input type="number" className="quo-editor-price__input quo-editor-price__input--num" value={line.unitPrice} onChange={(e) => updateLine(line.id, { unitPrice: Number(e.target.value) })} />
      ...
      <div className="quo-editor-price__summary">
        ...
        {editable ? (
          <>
            <div className="quo-editor-price__summary-row">
              <span>Freight</span>
              <input type="number" className="quo-editor-price__summary-input" value={freightAmount} onChange={(e) => onChange?.(synced, { freightAmount: Number(e.target.value), installationAmount, customCharges })} />
            </div>
            <div className="quo-editor-price__summary-row">
              <span>Installation</span>
              <input type="number" className="quo-editor-price__summary-input" value={installationAmount} onChange={(e) => onChange?.(synced, { freightAmount, installationAmount: Number(e.target.value), customCharges })} />
            </div>
          </>
        ) : (
          <>
