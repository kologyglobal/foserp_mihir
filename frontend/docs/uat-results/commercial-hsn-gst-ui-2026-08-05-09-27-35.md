...
| LIVE-01 | Permissions | PASS | Admin session can use commercial tax routes (override perm optional on login DTO) | role=Admin,Tenant Admin (live) |
