...
const TONE: Record<string, string> = {
  ...
  PACKAGE_READY: 'bg-indigo-100 text-indigo-900',
  PENDING_CHECKER: 'bg-amber-100 text-amber-950',
  SUBMITTED_SIMULATED: 'bg-sky-100 text-sky-900',
  ACCEPTED_SIMULATED: 'bg-emerald-100 text-emerald-900',
  LIVE_BLOCKED: 'bg-rose-100 text-rose-900',
  FAILED: 'bg-rose-100 text-rose-900',
  MARKED_FILED: 'bg-emerald-100 text-emerald-900',
  LOCKED: 'bg-indigo-100 text-indigo-900',
  'Marked Filed Externally': 'bg-emerald-100 text-emerald-900',
  MARKED_FILED_EXTERNAL: 'bg-emerald-100 text-emerald-900',
