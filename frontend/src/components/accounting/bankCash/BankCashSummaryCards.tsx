...
export function BankCashSummaryCards({
  items,
  activeId,
  columns,
}: {
...
export function BankCashEmptyState({
  title,
  description,
  actions,
}: {
...
/** Standard demo-data disclaimer for Bank & Cash screens — no live banking integration. */
export function BankCashDemoBanner({
  message = 'Balances shown are based on frontend demo data. Live banking integration is not connected.',
}: {
  message?: string
}) {
  return (
