...
export function ManufacturingAccountingSummaryCards({
  items,
  activeId,
  columns,
}: {
...
export function ManufacturingAccountingEmptyState({
  title,
  description,
  actions,
}: {
...
export function ManufacturingAccountingDemoBanner({
  message = 'Manufacturing costs shown are frontend demo data. No live production, inventory or general ledger posting is connected.',
}: {
  message?: string
}) {
  return (
