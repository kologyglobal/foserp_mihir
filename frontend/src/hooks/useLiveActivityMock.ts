...
const MOCK_EVENTS: Omit<LiveActivityEvent, 'id' | 'timestamp'>[] = [
  { icon: 'qc', action: 'WO-0003 moved to QC Pending', user: 'System', documentRef: 'WO-0003', href: '/work-orders', simulated: true },
  ...
  { icon: 'material', action: 'Material shortage detected for Axle ABS-6620', user: 'MRP', documentRef: 'Item ABS-6620', href: '/mrp', simulated: true },
  ...
  { icon: 'material', action: 'Steel plate stock below reorder for chassis line', user: 'MRP', documentRef: 'Item STL-12', href: '/mrp/planner', simulated: true },
]
