...
import {
  InventoryCostingSummaryPage,
  InventoryCostEntriesPage,
  InventoryCostEntryDetailPage,
  InventoryFifoLayersPage,
  InventoryFifoLayerDetailPage,
  InventoryAverageCostPage,
  InventoryStandardCostPage,
  InventorySpecificIdPage,
  InventoryValuationReconPage,
  InventoryMethodChangePage,
...
const demoInventoryRouteChildren: RouteObject[] = [
  ...
  { path: 'inventory/costing', element: <InventoryCostingSummaryPage /> },
  { path: 'inventory/costing/entries', element: <InventoryCostEntriesPage /> },
  { path: 'inventory/costing/entries/:id', element: <InventoryCostEntryDetailPage /> },
  { path: 'inventory/costing/layers', element: <InventoryFifoLayersPage /> },
  { path: 'inventory/costing/layers/:id', element: <InventoryFifoLayerDetailPage /> },
  { path: 'inventory/costing/fifo-layers', element: <Navigate to="/inventory/costing/layers" replace /> },
  { path: 'inventory/costing/average', element: <InventoryAverageCostPage /> },
  { path: 'inventory/costing/moving-average', element: <Navigate to="/inventory/costing/average" replace /> },
  { path: 'inventory/costing/standard', element: <InventoryStandardCostPage /> },
  { path: 'inventory/costing/standard-costs', element: <Navigate to="/inventory/costing/standard" replace /> },
  { path: 'inventory/costing/specific', element: <InventorySpecificIdPage /> },
  { path: 'inventory/costing/specific-identification', element: <Navigate to="/inventory/costing/specific" replace /> },
  { path: 'inventory/costing/reconciliation', element: <InventoryValuationReconPage /> },
  { path: 'inventory/costing/method-change', element: <InventoryMethodChangePage /> },
...
const apiInventoryRouteOverrides: Record<string, ReactElement> = {
  ...
  'inventory/costing': <InventoryCostingSummaryPage />,
  'inventory/costing/entries': <InventoryCostEntriesPage />,
  'inventory/costing/entries/:id': <InventoryCostEntryDetailPage />,
  'inventory/costing/layers': <InventoryFifoLayersPage />,
  'inventory/costing/layers/:id': <InventoryFifoLayerDetailPage />,
  'inventory/costing/average': <InventoryAverageCostPage />,
  'inventory/costing/standard': <InventoryStandardCostPage />,
  'inventory/costing/specific': <InventorySpecificIdPage />,
  'inventory/costing/reconciliation': <InventoryValuationReconPage />,
  'inventory/costing/method-change': <InventoryMethodChangePage />,
