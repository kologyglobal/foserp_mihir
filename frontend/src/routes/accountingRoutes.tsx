...
import {
  ...
  Gstr1Page,
  Gstr3bPage,
  GstSalesRegisterPage,
  GstPurchaseRegisterPage,
  GstRcmRegisterPage,
  GstHsnRegisterPage,
  GstStateRegisterPage,
  GstLiabilitySummaryPage,
  GstItcSummaryPage,
  GstPaymentSummaryPage,
  GstPaymentChallansPage,
  GstExportSezLutPage,
  GstSpecialsPage,
  GstHardeningCockpitPage,
  GstPortalFilingPage,
  GstAnnualCompliancePage,
  GstRateOpsPage,
  GstDataQualityPage,
  GstGlReconPage,
  GstComplianceCockpitPage,
...
import {
  ...
  CrmPendingInvoicesPage as MoneyInCrmPendingInvoicesPage,
  CrmReceiptMigrationPage as MoneyInCrmReceiptMigrationPage,
...
export const accountingRouteChildren: RouteObject[] = [
  ...
  { path: 'accounting/money-in/crm-pending', element: <MoneyInCrmPendingInvoicesPage /> },
  { path: 'accounting/money-in/crm-receipt-migration', element: <MoneyInCrmReceiptMigrationPage /> },
  ...
  { path: 'accounting/money-in/corrections', element: <MoneyInCorrectionsWorkspacePage /> },
  ...
  { path: 'accounting/tax-compliance/gst/registers/sales', element: <GstSalesRegisterPage /> },
  { path: 'accounting/tax-compliance/gst/registers/purchase', element: <GstPurchaseRegisterPage /> },
  { path: 'accounting/tax-compliance/gst/registers/rcm', element: <GstRcmRegisterPage /> },
  { path: 'accounting/tax-compliance/gst/registers/hsn', element: <GstHsnRegisterPage /> },
  { path: 'accounting/tax-compliance/gst/registers/state', element: <GstStateRegisterPage /> },
  { path: 'accounting/tax-compliance/gst/registers/liability', element: <GstLiabilitySummaryPage /> },
  { path: 'accounting/tax-compliance/gst/registers/itc', element: <GstItcSummaryPage /> },
  { path: 'accounting/tax-compliance/gst/registers/payment', element: <GstPaymentSummaryPage /> },
  { path: 'accounting/tax-compliance/gst/payments', element: <GstPaymentChallansPage /> },
  { path: 'accounting/tax-compliance/gst/export-sez-lut', element: <GstExportSezLutPage /> },
  { path: 'accounting/tax-compliance/gst/specials', element: <GstSpecialsPage /> },
  { path: 'accounting/tax-compliance/gst/compliance-cockpit', element: <GstComplianceCockpitPage /> },
  { path: 'accounting/tax-compliance/gst/go-live', element: <GstHardeningCockpitPage /> },
  { path: 'accounting/tax-compliance/gst/rate-ops', element: <GstRateOpsPage /> },
  { path: 'accounting/tax-compliance/gst/data-quality', element: <GstDataQualityPage /> },
  { path: 'accounting/tax-compliance/gst/gl-recon', element: <GstGlReconPage /> },
  { path: 'accounting/tax-compliance/gst/annual', element: <GstAnnualCompliancePage /> },
  { path: 'accounting/tax-compliance/gst/gstr-1', element: <Gstr1Page /> },
  { path: 'accounting/tax-compliance/gst/gstr-3b', element: <Gstr3bPage /> },
  { path: 'accounting/tax-compliance/gst/portal-filing', element: <GstPortalFilingPage /> },
