...
/**
 * 30 m³ Tipper FE Type — mapped from VF/QUO/26-27/146
 * Source: `146.30 FE m3 Tipper.docx`
 * Dynamic merge fields: {{quotation_no}}, {{customer_*}}, {{product_*}}, etc.
 */
export const TIPPER_30FE_M3_SECTIONS: TemplateSection[] = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
...
export const TIPPER_30FE_M3_TEMPLATE_ID = 'qtpl-tipper-30fe-m3'
export const TIPPER_30FE_M3_TEMPLATE_VERSION = 1
