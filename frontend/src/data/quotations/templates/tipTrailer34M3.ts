...
/**
 * 34 m³ Tip Trailer — mapped from VF/QUO/26-27/184
 * Source: `184.34m3 Tip Trailer.docx`
 * Dynamic merge fields: {{reference_no}}, {{customer_*}}, {{product_name}}, etc.
 */
export const TIP_TRAILER_34M3_SECTIONS: TemplateSection[] = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
...
export const TIP_TRAILER_34M3_TEMPLATE_ID = 'qtpl-tip-trailer-34m3'
export const TIP_TRAILER_34M3_TEMPLATE_VERSION = 1
