...
/**
 * 23 m³ Bulker — mapped from VF/QUO/26-27/175
 * Source: `175.23m3 Bulker.docx`
 * Dynamic merge fields: {{reference_no}}, {{customer_*}}, {{product_name}}, etc.
 */
export const BULKER_23M3_SECTIONS: TemplateSection[] = [
  {
    sectionType: 'cover',
    title: 'Quotation',
    content: [
...
export const BULKER_23M3_TEMPLATE_ID = 'qtpl-bulker-23m3'
export const BULKER_23M3_TEMPLATE_VERSION = 1
