...
export const MASTER_MODULE_GROUPS: MasterModuleGroup[] = [
  ...
  },
  {
    ...
    masters: [
      ...
      def('bins', 'BIN Code Master', '/masters/bins', 'inventory', MapPin, {
        description: 'Storage bin codes for purchase lines and GRN',
        countKey: 'bins',
        permissionKey: 'masters.bins',
      }),
      def('receiving-tolerances', 'Receiving Tolerance', '/masters/receiving-tolerances', 'inventory', Scale, {
        description: 'Excess-only GRN unit and weight tolerance bands',
        countKey: 'receivingTolerances',
        permissionKey: 'masters.receiving-tolerances',
      }),
    ],
  },
  {
