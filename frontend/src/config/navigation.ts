...
export const moduleCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Today’s Work (MFG)', path: '/inventory/store-workbench', icon: ClipboardList, subNav: false },
      { label: 'Items', path: '/inventory/items', icon: Package, subNav: false },
      { label: 'Receive Stock (register)', path: '/inventory/movements/receipts', icon: ArrowDownToLine, subNav: false },
      { label: 'Issue Stock (register)', path: '/inventory/movements/issues', icon: ArrowUpFromLine, subNav: false },
      { label: 'Move Between Warehouses', path: '/inventory/movements/transfers', icon: GitBranch, subNav: false },
      { label: 'Adjust Stock', path: '/inventory/movements/adjustments', icon: SlidersHorizontal, subNav: false },
      ...
      /** Reorder Planning / Accounting / Costing relocated to Manufacturing + Accounting categories below —
       *  intentionally not listed here so /inventory/planning|accounting|costing resolve to those module rails. */
    ],
  },
  {
    id: 'purchase',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Inventory Events', path: '/inventory/accounting', icon: Landmark },
      { label: 'Inventory Costing', path: '/inventory/costing', icon: Calculator },
