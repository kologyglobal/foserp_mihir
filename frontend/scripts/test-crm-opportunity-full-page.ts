...
check(12, 'New page product pricing section', newPage.includes('ErpProductPricingSection'))
check(13, 'Edit page product pricing section', editPage.includes('ErpProductPricingSection'))
